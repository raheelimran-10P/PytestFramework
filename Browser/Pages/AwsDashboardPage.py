...
class AwsDashboardPage(BasePage):
    ...
    SIMULATION_START = (By.XPATH, "//button[text()='Start simulation(s)']")
    SIMULATION_REFRESH = (By.XPATH, "//*[text()='Refresh']")
    ...
    def run_simulations_without_wait(self):
        ...
        # self.wait(1)
        self.is_visible(self.SIMULATION_START)
        self.driver.find_element(By.XPATH, "//button[text()='Start simulation(s)']").click()
        # self.do_click(self.SIMULATION_START)
        self.wait()
        self.is_visible(self.SIMULATION_REFRESH)
        self.do_click(self.SIMULATION_REFRESH)
